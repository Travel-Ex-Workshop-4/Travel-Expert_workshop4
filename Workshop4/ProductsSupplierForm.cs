...
namespace Workshop4 {
    public partial class ProductsSupplierForm : Form {
        ...
        List<Products_Suppliers> prodSuppList = ProductsSupplierDB.GetAllProductsSuppliers();
        Products_Suppliers selectedProdSuppObj;
        ...
        private void DisplayProdSupp(Products_Suppliers prodSuppObj) {
        ...
        private void btnAddProdSupp_Click(object sender, EventArgs e) {
            Products_Suppliers newProdSuppObj = new Products_Suppliers();
